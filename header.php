    ...
    <nav class="navbar navbar-default navbar-fixed-top" id="scrollspy">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Perusahaan Jelyta Group </a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="contact.php"><span class="glyphicon glyphicon-comment"></span> Contact Us</a>
						</li>
            <li>
							<a href="karyawan.php"><span class="glyphicon glyphicon-stats"></span> Karyawan</a>
						</li>
